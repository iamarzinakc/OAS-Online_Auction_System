    ...
    <form action="{{route('product.store')}}" method="POST" enctype="multipart/form-data">
      ...
      <div class="row page-section">
        ...
        <div class="col-md-4 mb-3">
          ...
          <input type="number" class="form-control" name="model_no" placeholder="Enter Product Modle No">
        </div><!-- /.form-group -->

        <!-- .form-group -->
        <div class="col-md-4 mb-3">
          <label class="control-label" for="select2-single">Product Condition</label><abbr title="Required">*</abbr>
          <select class="custom-select" id="selDefault" placeholder="Enter Product Condition" name="condition">
            <option value=""></option>
        ...
        <div class="col-md-3 mb-3">
          ...
          <abbr title="Required">*</abbr>
          <input type="date" class="form-control" id="tfDefault" name="buy_year">
        </div><!-- /.form-group -->
        ...
        <div class="col-md-12 mb-3">
          ...
          <abbr title="Required">*</abbr>
          <textarea class="form-control" id="tf6" rows="4" name="description" placeholder="Electrical Product Description"></textarea>
        </div><!-- /.form-group -->
