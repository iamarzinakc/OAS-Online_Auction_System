!(function(t, e) {
    ...
    function g(t, e) {
        (e = '"'
            ...
            .concat(e, '" instead.')), -1 === K.indexOf(e) && (K.push(e), z(e));
    }
        ...
        n
            ...
            (Jt().then(function() {
                ...
                oe.keydownTarget.removeEventListener(
                    "keydown",
                    oe.keydownHandler, { capture: oe.keydownListenerCapture }
                ),
        ...
        return new Promise(function(t) {
            ...
            ye.swalPromiseResolve.set(a, t),
                ...
                (t.keydownTarget.removeEventListener(
                        "keydown",
                        t.keydownHandler, { capture: t.keydownListenerCapture }
                    ),
